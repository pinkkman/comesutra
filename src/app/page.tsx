  ...
  return (
    <div className="flex min-h-screen w-full flex-col">
      <main className="flex-1">
        <section className="relative flex h-screen min-h-[700px] w-full flex-col items-center justify-center space-y-8 px-4 text-center">
          <div className="space-y-4">
            <h1 className="font-headline text-5xl font-black tracking-tight text-primary drop-shadow-lg sm:text-7xl lg:text-8xl">
              COME सूत्र
            </h1>
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="grid gap-10 sm:px-10 md:grid-cols-3 md:gap-16">
              {eventDetails.map((detail) => (
                <Card
                  key={detail.title}
                  className="flex flex-col items-center border-2 bg-transparent text-center shadow-lg transition-transform hover:scale-105 hover:border-primary"
                >
